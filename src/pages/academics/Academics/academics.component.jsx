    ...
    <div className="academics">
      <div className="school">
        <div class="col-md-4 col-sm-6 " className="center acadContent">
          ...
          <img
            alt="randomacdemic"
            className="pleaseresize"
            src="https://i.ytimg.com/vi/bFGH_fFyWoo/maxresdefault.jpg"
          ></img>
        </div>
      </div>
      ...
      <div className="school second">
        <div class="col-md-8 center acadContent">
          ...
          <img
            alt="randomresize"
            className="pleaseresize"
            src="https://assets.telegraphindia.com/telegraph/19DhanDeNobili4_184917.jpg"
          ></img>
        </div>
      </div>
      ...
      <div className="school">
        <div class="col-md-8 center acadContent">
          ...
          <img
            alt="randomacademic"
            className="pleaseresize"
            src="https://schools.thelearningpoint.net/pics-cbse/schoolPic58049.JPG"
          ></img>
        </div>
      </div>
    </div>
